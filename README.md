...
- 最新版本：**v1.0.0**
- 下载地址：[Qiandaizi-v1.0.0.apk](https://github.com/qiancheng817/qiandaizi-android/releases/download/v1.0.0/Qiandaizi-v1.0.0.apk)（约 18.7 MB）
...
- 自动执行 `assembleDebug`，并将 APK 发布到 Release（tag `v1.0.0`）
