...
- 最新版本：**v1.4.0**
- 下载地址：[Qiandaizi-v1.4.0.apk](https://github.com/qiancheng817/qiandaizi-android/releases/download/v1.4.0/Qiandaizi-v1.4.0.apk)（约 12.5 MB，正式签名包）
...
- 自动执行 `assembleRelease`（正式签名包），并将 APK 发布到 Release（tag `v1.4.0`）
